...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :jobs, 'Jobs', jobs_path, :highlights_on => /(^\/jobs)/
    primary.item :news, 'News', newsblogs_path, :highlights_on => /(^\/newsblogs)/
